<?php
 ...
 $dbConn -> setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION); //Allows errors to be seen when retrieving data
 ...
 print_r($records);
 echo "Total products bought by Female: " . $records[0]["SUM(quantity)"] . "<br>";
 echo "Total products bought by Male: " . $records[1]["SUM(quantity)"];
 
 echo "<br><br> Product categories bought in February: ";
 ...
 foreach ($records as $record) {
  ...
  array_push($products, $record["catName"]);
